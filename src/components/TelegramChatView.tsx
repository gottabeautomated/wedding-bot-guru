...
export const TelegramChatView = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto overflow-hidden rounded-lg shadow-lg border border-gray-200">
      {/* Telegram header */}
      <div className="telegram-header">
        <div className="flex items-center gap-3">
          <ChevronLeft className="w-5 h-5" />
          <div>
            <h3 className="font-medium text-base">Weddingplanner-Agent</h3>
        ...
        {messages.map((message, index) => (
          ...
          >
            ...
            {message.inlineKeyboard && (
              <TelegramInlineKeyboard buttons={message.inlineKeyboard} />
            )}
          </motion.div>
        ))}
        
        {isTyping && (
          <div className="flex items-center gap-2 text-sm text-gray-500 mt-2 ml-2">
      ...
      <div className="bg-white border-t border-gray-200 p-3 flex items-center gap-2">
        ...
        <input
          type="text"
          className="flex-1 py-2 px-3 rounded-full bg-gray-100 focus:outline-none focus:ring-1 focus:ring-telegram-blue"
